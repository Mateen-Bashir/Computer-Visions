...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Path to optional calibration json created by calibrate_template.py",
    )
    parser.add_argument(
        "--template-points",
        default="models/template_points.json",
        help="Path to optional exact template points json created by create_template_points.py",
    )
