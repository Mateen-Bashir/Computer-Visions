...
- current `answer_key.csv` contains some `MULTI`/`BLANK` values for certain rows. The pipeline supports this.
- later add real sheet photos, this system can evaluate them by updating the sheet template mapping.
